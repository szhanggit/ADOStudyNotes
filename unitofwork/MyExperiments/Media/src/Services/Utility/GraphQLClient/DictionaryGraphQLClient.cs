...
namespace Services.Utility.GraphQLClient
{
    ...
    public class DictionaryGraphQLClient : ITXCGraphQLClient
    {
        public IGraphQLClient GraphQLClient { get; }
        public DictionaryGraphQLClient(IConfiguration configuration)
        {
            GraphQLClient = new GraphQLHttpClient(configuration["ServiceUrlConfiguration:ServiceDictionaryUrl"], new NewtonsoftJsonSerializer());
        }
