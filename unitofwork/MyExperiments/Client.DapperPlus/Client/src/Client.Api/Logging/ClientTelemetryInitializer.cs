...
namespace Client.Api.Logging
{
    public class ClientTelemetryInitializer : ITelemetryInitializer
    {
        private readonly IConfiguration _configuration;
        public ClientTelemetryInitializer(IConfiguration configuration)
        {
