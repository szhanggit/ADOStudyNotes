...
{
    public interface IClientAddressFetchingGraphQLService
    {
        ...
        Task<ProtoBaseResponse> GetClientsByCodeAsync(GetClientListModel request);
    }
    public class ClientAddressFetchingGraphQLService : IClientAddressFetchingGraphQLService
    {
        private IGraphQLGatewayClient _graphQLGatewayClient;
        private IClientHelperService _clientHelperService;
        private IObjectConvertingService _objectConvertingService;
        public ClientAddressFetchingGraphQLService(IGraphQLGatewayClient graphQLGatewayClient, IClientHelperService clientHelperService, IObjectConvertingService objectConvertingService)
        {
            _graphQLGatewayClient = graphQLGatewayClient;
        ...
        public async Task<ProtoBaseResponse> GetClientsAsync(GetClientListModel request)
        {
            ...
            var graphqlClient = _graphQLGatewayClient.GetGraphQLClient(request.TenantId);
            ...
            if (graphqlClient != null)
            {
                ...
                if (_clientList != null)
                {
                    ...
                    {
                        ClientListItem client = _objectConvertingService.ConvertClientModelToClientListItem(item);
        ...
        public async Task<ProtoBaseResponse> GetClientsByCodeAsync(GetClientListModel request)
        {
            int? TotalCount = 0;
            ClientListItem ClientItem = null;
            TXC.Proto.Client.GetClientListResponse response = new TXC.Proto.Client.GetClientListResponse();
            ...
            if (graphqlClient != null)
            {
                ...
                ClientModel _client = clientFetchingResult?.Data?.ClientByCode.FirstOrDefault();
                ClientItem = _objectConvertingService.ConvertClientModelToClientListItem(_client);                
            }
