namespace Service.Utility
{
    ...
    public class SecurityKeyService : ISecurityKeyService
    {
        ...
        private readonly IDammAlgorithm _dammAlgorithm;

        public SecurityKeyService(IDammAlgorithm dammAlgorithm)
        {
            this._dammAlgorithm = dammAlgorithm;
        }
        ...
        public string GenerateSecurityKey(int length)
        {
            ...
            SecurityKey += _dammAlgorithm.CalculateCheckSum(confusedVoucherNumber);
