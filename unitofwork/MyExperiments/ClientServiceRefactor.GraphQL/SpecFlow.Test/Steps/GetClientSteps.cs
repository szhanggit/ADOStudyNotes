...
namespace SpecFlow.Test.Steps
{
    ...
    public class GetClientSteps : CommonHelper
    {
        ...
        public async Task ExecuteAsync()
        {
            ...
            //using (Repository.EF.OperationSession oSession = new Repository.EF.OperationSession(_dbConnection.ConnectionString))
            //{
            //    var _client = await oSession.clientBasicInfoRepository.GetClientByIdAsync(1);
            //    await oSession.UnitOfWork.CompleteAsync();
            //}
        }
    }
}
