...
namespace LearnDapper_0
{
    public class Program
    {
        ...
        public static int Delete(Student_Class sc)
        {
            using (IDbConnection connection = new SqlConnection(connectionString))
            {
                return connection.Execute("delete from student_class where studentid = @SId and classid = @CId", sc);
            }
        }
        ...
        public static int Delete(List<Student_Class> sclist)
        {
            using (IDbConnection connection = new SqlConnection(connectionString))
            {
                return connection.Execute("delete from student_class where studentid = @SId and classid = @CId", sclist);
            }
        }
        ...
        public static int Update(Student student)
        {
            using (IDbConnection connection = new SqlConnection(connectionString))
            {
                return connection.Execute("update Student set studentname=@studentname where studentid=@studentId", student);
            }
        }
        ...
        public static int Update(List<Student> studentlist)
        {
            using (IDbConnection connection = new SqlConnection(connectionString))
            {
                return connection.Execute("update Student set studentname=@studentname where studentid=@studentId", studentlist);
            }
        }
        ...
        public static Student Query(int studentId)
        {
            ...
            using (IDbConnection connection = new SqlConnection(connectionString))
            {
                return connection.Query<Student>("select * from Student where studentid=@studentId", (new Student(studentId))).SingleOrDefault();
            }
        }
